...
public class BatchImportIT {
	public static final Logger ourLog = LoggerFactory.getLogger(BatchImportIT.class);
	public static final String A_JOB_ID = "0000000-A1A1A1A1";
	public final FhirContext myCtx = FhirContext.forR4Cached();
	public final BulkDataImportProvider myProvider = new BulkDataImportProvider();
	@RegisterExtension
	public RestfulServerExtension myRestfulServerExtension = new RestfulServerExtension(myCtx, myProvider);
	@RegisterExtension
	public final HttpClientExtension myClient = new HttpClientExtension();
	@Mock
	public IJobCoordinator myJobCoordinator;
	@Captor
	public ArgumentCaptor<JobInstanceStartRequest> myStartRequestCaptor;
